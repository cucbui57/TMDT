            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo URL ?>sanpham/danhmuc/<?php echo $category_parents[0]->description ?>">Sản phẩm</a>
                        </li>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <ul>
                        ...
                        ?>
                        <li><a href="<?php echo URL ?>sanpham/danhmuc/<?php echo $category_parent->description ?>"><?php echo $category_parent->name ?></a>
                        </li>
                        <?php } ?>
                    </ul>
